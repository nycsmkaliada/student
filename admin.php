		...
		<div class="row">
			<div class="col-sm-12">
				...
				<ul><li>Student Managment
					<ul>
					<li><a href="">New Addmission</a></li>
					<li><a href="add_stu.php">Add  Student</a></li>
					<li><a href="">Show Results</a></li>
					<li><a href="">Bill Generate</a></li></ul>
				</li>
					<li>Question Management
					<ul>
					<li><a href="add_ques1.php">Add 1st sem Question</a></li>
					<li><a href="">Add 2nd Sem Quesiton</a></li>
					<li><a href="">Edit 1st sem Question</a></li>
					<li><a href="">Edit 2nd sem Question</a></li>
					<li><a href="">Delete Question</a></li></ul>
				</li><li>Others Management
					<ul>
					<li><a href="">Enquiry</a></li>
					<li><a href="show_1stsem.php">Show 1s Sem</a></li>
					<li><a href="">Show 2nd Sem</a></li></ul>
				</li>
