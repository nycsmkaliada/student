...
$id = $_GET['id'];
$sql = "SELECT * FROM add_ques1 WHERE id = $id";
...
if(isset($_POST['edit'])){
	...
	$opt4 = $_POST['opt4'];
	$ans = $_POST['ans'];
	$update = "UPDATE add_ques1 SET ques='$ques',opt1='$opt1',opt2='$opt2',opt3='$opt3',opt4='$opt4',ans='$ans' WHERE id='$id'";
				...
				<div class="col-sm-12" >
					<form action="" method="post">
						<center><table class="table table-success table-borderless" >
							<tr class="table-warning" align="center"><td colspan="2"><h2>1st Sem Question Edit Table</h2></td></tr>
