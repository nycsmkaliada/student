		...
		<div class="col-sm-12">
			...
			<div class="row">
				<div class="col-sm-3" style="margin-top: 20px;">
					<form action="add_ques2c.php" method="post">
						<center><table class="table table-success table-borderless">
							<tr class="table-warning" align="center"><td colspan="2"><h2>2nd Sem Question Add Table</h2></td></tr>
				...
				<div class="col-sm-9" style="margin-top: 20px;">
					<table class="table table-borderless">
						...
						<?php 
						$quer = "SELECT * FROM add_ques2 order by id desc";
