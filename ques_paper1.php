...
<div class="container-fluid">
	<div class="head">
			...
			<span id="time" style="margin-left: -20px; padding: 10px; background-color: blue; color: white; position: fixed;font-size: 25px;"> </span>
	<div class="row">
		<div class="col-sm-10 offset-1">
			
				<?php
				$id = rand(0,100);
				$question = "SELECT * FROM `add_ques1`order by rand() limit 25";
